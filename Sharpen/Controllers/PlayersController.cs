...
namespace Sharpen.Controllers
{
    public class PlayersController : Controller
    {
        ...
        // GET: Players/Create
        public IActionResult Create(string xp)
        {
            ViewData["Xp"] = xp;
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Level,CurrentHitPoints,MaximumHitPoints,Gold,ExperiencePoints,StartingDate")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
